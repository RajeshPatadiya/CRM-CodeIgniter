...
$("#submitForm").click(function(){
	...
	$.ajax({
		type: "POST",
		url: "modifierClientcon",
		data: {id_client:id_clientc,nom:nomc,prenom:prenomc,adresse:adressec,numero:numeroc,code_tva:code_tvac,matricule_fiscale:matricule_fiscalec},
