...
<head>
	...
	<meta name="author" content="solutionportal"><!DOCTYPE html>
<html>
<head>
									...
									<form role="form" class="form-horizontal" action="javascript:;"> <!-- form horizontal acts as a row -->
										<!-- normal control -->
                                         <div class="form-group">
											<label class="col-md-3 control-label">ID_devis:</label>
											<div class="col-md-9">
												<input type="text" class="form-control" name="id_devis" id="id_devis">
											</div>
										</div>
										<div class="form-group">
...
$("#submitForm").click(function(){
	...
	$.ajax({
		type: "POST",
		url: "modifierDeviscont",
		data: {id_devis:id_devis,id_client:id_client,date_envoie:date_envoie,date_validation:date_validation},
