								...
								<div class="panel-body">
									<form role="form" class="form-horizontal" action="javascript:;"> <!-- form horizontal acts as a row -->
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  name="id_devis">
											</div>
										<div class="form-group">
											<label class="col-md-3 control-label">Date_envoie:</label>
											<div class="col-md-9">
										...
										<div class="form-group">
											<label class="col-md-3 control-label"> Date_validation: </label>
											<div class="col-md-9">
