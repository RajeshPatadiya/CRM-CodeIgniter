								...
								<div class="panel-body">
									<form role="form" class="form-horizontal" action="javascript:;"> <!-- form horizontal acts as a row -->
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Nom Service</label>
											<div class="col-md-9">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" placeholder="Password Text" name="type_service">
											</div>
										</div> 
										...
										<div class="clearfix right">
											<input class="btn btn-primary mr5" type="submit" value="ajouter" name="submit" ></input>
