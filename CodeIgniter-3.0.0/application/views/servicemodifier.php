								...
								<div class="panel-body">
									<form role="form" class="form-horizontal" action="javascript:;"> <!-- form horizontal acts as a row -->
										...
										<div class="form-group">
                                        	...
                                        	<div class="form-group">
											<label class="col-md-3 control-label">nom_service</label>
											<div class="col-md-9">
												<input type="text" class="form-control" name="nom_service">
											</div>
										</div>
                                        	<div class="form-group">
											<label class="col-md-3 control-label">type_service</label>
											<div class="col-md-9">
										...
										<div class="clearfix right">
											<input class="btn btn-primary mr5" name="submit" value="ajouter" type="submit"></input>
