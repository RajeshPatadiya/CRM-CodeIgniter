			    ...
			    <div class="row">
						...
						<div class="col-md-6">
						  <div class="panel panel-default panel-hovered panel-stacked mb30">
								<div class="panel-heading">Modifier un service</div>
								<div class="panel-body">
									<form role="form" class="form-horizontal" action="javascript:;"> <!-- form horizontal acts as a row -->
                                        ...
                                        <div class="form-group">
											<label class="col-md-5 control-label">Nom de service:</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="nom_service" id="nom_service">
											</div>
										</div>
                                          <div class="form-group">
											<label class="col-md-5 control-label">Type de service:</label>
											<div class="col-md-7">
												<input type="text" class="form-control" name="type_service" id="Type_service">
											</div>
										</div>
...
<script src="<?php echo base_url('public/scripts/plugins/c3.min.js')?>"></script>
...
$("#submitForm").click(function(){
	...
	var ids= $("#id_service").val();
	var noms= $("#nom_service").val();
	var types= $("#type_service").val();
	
	//var urlStr = "ajouter1.php?id="+id+"&nom="+nom+"&prenom="+prenom+"&adresse="+adresse+"&numero="+numero;
	$.ajax({
		type: "POST",
		url: "modifierService",
		data: {id_service:ids,nom_service:noms,type_service:types},
